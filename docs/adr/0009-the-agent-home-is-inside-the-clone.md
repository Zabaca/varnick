...
Considered: one home per Worktree, which scatters skills and loses transcripts on reap; pointing the agent at your real `~/.claude`, which makes the agent's mistakes yours.
