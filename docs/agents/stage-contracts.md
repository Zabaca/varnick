...
| 4. Bare page | *nothing visual* | Hard checkpoint. The bare page exists to prove behaviour with no design covering for it. No writes to `DESIGN.md` or the surface brief here. It is a stage rather than a deliverable — see [ADR-0013](../adr/0013-behaviour-is-proved-headlessly.md) for when it has done its job and can go. |
